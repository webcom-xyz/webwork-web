...
const navigation = [
  ...
  { name: "Objectives", href: "#", icon: FlagIcon, current: false },
  { name: "KPI", href: "#", icon: HashtagIcon, current: false },
  { name: "OKR", href: "#", icon: KeyIcon, current: false },
  { name: "Tasks", href: "#", icon: InboxIcon, current: false },
];
const teams = [
  // { name: "OK", href: "#", bgColorClass: "bg-blue-600" },
  { name: "Updated", href: "#", bgColorClass: "Vượt chỉ tiêu" },
